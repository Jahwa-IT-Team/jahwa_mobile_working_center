...
class JimsEmployeeInfo extends StatefulWidget {
  @override
  _JimsEmployeeInfoState createState() => _JimsEmployeeInfoState();
}

class _JimsEmployeeInfoState extends State<JimsEmployeeInfo> {
    ...
    return GestureDetector( /// Keyboard UnFocus시를 위해 onTap에 GestureDetector를 위치시킴
      ...
      child: Scaffold(
        appBar: AppBar(
          ...
          title: Text('Employee Info', style: TextStyle(fontWeight: FontWeight.bold, color: Colors.white, fontSize: 15,),),
        ),
  ...
  Future<void> makePageBody() async {
    ...
    try {
      ...
      // Send Parameter
      var data = {'EmpCode': '', 'Name' : searchController.text};
                    ...
                    children: <Widget>[
                      ...
                      Container(
                        ...
                        child: FlatButton(
                          ...
                          child: Text('사무실 : ' + element['OfficeTel'], style: TextStyle(fontSize: 14,)),
                      ...
                      Container(
                        ...
                        height: 30,
                        child: FlatButton(
                          onPressed: () => launch("tel://" + element['Mobile']),
                          child: Text('휴대폰 : ' + element['Mobile'], style: TextStyle(fontSize: 14,)),
                          padding: EdgeInsets.only(left: 20),
                        ),
                      ),
                    ],
